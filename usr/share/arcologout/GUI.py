...
def GUI(self, Gtk, GdkPixbuf, working_dir, os, Gdk, fn):
    ...
    self.lbl4 = Gtk.Label()
    self.lbl4.set_markup("<span size=\"" + str(self.font) + "000\">Lock ({})</span>".format(self.binds['lock']))
    self.lbl4.set_name("lbl")
    self.lbl5 = Gtk.Label()
    self.lbl5.set_markup("<span size=\"" + str(self.font) + "000\">Logout ({})</span>".format(self.binds['logout']))
